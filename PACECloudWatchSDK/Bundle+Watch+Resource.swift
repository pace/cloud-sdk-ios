...
public extension Bundle {
    ...
    static var resource: Bundle = {
        let moduleName = "PACECloudWatchSDK"
        #if COCOAPODS
        ...
        guard let bundle = Bundle(identifier: "cloud.pace.watch.sdk") else { fatalError("Unable to find bundle named \(bundleName)") }
