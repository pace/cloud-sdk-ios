...
class PACECloudSDKTests: XCTestCase {
    ...
    func testCommonUrls() {
        PACECloudSDK.shared.setup(with: .init(clientId: "", apiKey: "apiKey", environment: .development))
        ...
        PACECloudSDK.shared.setup(with: .init(clientId: "", apiKey: "apiKey", environment: .sandbox))
        ...
        PACECloudSDK.shared.setup(with: .init(clientId: "", apiKey: "apiKey", environment: .stage))
        ...
        PACECloudSDK.shared.setup(with: .init(clientId: "", apiKey: "apiKey", environment: .production))
