...
public extension IDKit {
    ...
    public struct TokenExchangeConfiguration {
        let exchangeIssuer:String
        let exchangeClientID:String
        let exchangeIssuerID:String
        let exchangeClientSecret:String
        
        public init(exchangeIssuer:String, exchangeClientID:String, exchangeIssuerID:String, exchangeClientSecret:String) {
            self.exchangeIssuer = exchangeIssuer
