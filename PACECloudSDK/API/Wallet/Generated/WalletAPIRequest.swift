...
public class WalletAPIRequest<ResponseType: APIResponseValue> {

    public let service: WalletAPIService<ResponseType>
    ...
    public init(service: WalletAPIService<ResponseType>,
...
extension WalletAPIRequest: CustomStringConvertible {
...
extension WalletAPIRequest: CustomDebugStringConvertible {
...
public class CancellableWalletAPIRequest {
    /// The request used to make the actual network request
    public let request: AnyWalletAPIRequest

    init(request: AnyWalletAPIRequest) {
