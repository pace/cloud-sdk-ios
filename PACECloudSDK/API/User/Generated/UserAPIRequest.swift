...
public class UserAPIRequest<ResponseType: APIResponseValue> {

    public let service: UserAPIService<ResponseType>
    ...
    public init(service: UserAPIService<ResponseType>,
...
extension UserAPIRequest: CustomStringConvertible {
...
extension UserAPIRequest: CustomDebugStringConvertible {
...
public class CancellableUserAPIRequest {
    /// The request used to make the actual network request
    public let request: AnyUserAPIRequest

    init(request: AnyUserAPIRequest) {
