...
In case no preferences were ever set an empty object `{}` is returned.
    */
    public enum GetAppPreferences {

        public static var service = UserAPIService<Response>(id: "GetAppPreferences", tag: "Preferences", method: "GET", path: "/preferences/{clientId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:preferences:read"]), SecurityRequirement(type: "OIDC", scopes: ["user:preferences:read"])])
        ...
        public final class Request: UserAPIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetAppPreferences.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(clientId: String? = nil) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decodeAnyJson(from: data))
