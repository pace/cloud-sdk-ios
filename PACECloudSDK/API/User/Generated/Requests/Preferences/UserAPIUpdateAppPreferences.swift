...
value not longer than 255 bytes (including complex json objects).
    */
    public enum UpdateAppPreferences {
        ...
        public static var service = UserAPIService<Response>(id: "UpdateAppPreferences", tag: "Preferences", method: "PUT", path: "/preferences/{clientId}", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:preferences:write"]), SecurityRequirement(type: "OIDC", scopes: ["user:preferences:write"])])
        ...
        public final class Request: UserAPIRequest<Response> {
            ...
            public init(body: [String: Any], options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(clientId: String? = nil, body: [String: Any]) {
