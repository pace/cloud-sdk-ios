...
extension UserAPI.Maintenance {

    /** Compares the scopes between our api-definitions and Keycloak */
    public enum PostMaintenanceCheckScopes {

        public static var service = UserAPIService<Response>(id: "postMaintenanceCheckScopes", tag: "Maintenance", method: "POST", path: "/maintenance/check-scopes", hasBody: true, securityRequirements: [])
        ...
        public final class Request: UserAPIRequest<Response> {
            ...
            public class Body: APIModel {
                ...
                public var data: PCUserScopesRequest?

                public init(data: PCUserScopesRequest? = nil) {
                    self.data = data
                }
            ...
            public init(body: Body, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: PostMaintenanceCheckScopes.service) { defaultEncoder in
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public var data: PCUserScopes?

                public init(data: PCUserScopes? = nil) {
                    self.data = data
                }
