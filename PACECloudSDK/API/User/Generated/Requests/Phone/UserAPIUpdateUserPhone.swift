...
If the process is not completed within 24h the process is canceled.
    */
    public enum UpdateUserPhone {

        public static var service = UserAPIService<Response>(id: "UpdateUserPhone", tag: "Phone", method: "PUT", path: "/user/phone", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:users.phone:update"]), SecurityRequirement(type: "OIDC", scopes: ["user:users.phone:update"])])
