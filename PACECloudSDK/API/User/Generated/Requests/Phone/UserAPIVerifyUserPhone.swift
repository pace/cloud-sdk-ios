...
extension UserAPI.Phone {
    ...
    */
    public enum VerifyUserPhone {

        public static var service = UserAPIService<Response>(id: "VerifyUserPhone", tag: "Phone", method: "PUT", path: "/user/phone/verify", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:users.phone:update"]), SecurityRequirement(type: "OIDC", scopes: ["user:users.phone:update"])])
