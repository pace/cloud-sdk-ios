...
extension UserAPI.Phone {
    ...
    */
    public enum CheckUserPhone {

        public static var service = UserAPIService<Response>(id: "CheckUserPhone", tag: "Phone", method: "GET", path: "/user/phone", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:users.phone:check"]), SecurityRequirement(type: "OIDC", scopes: ["user:users.phone:check"])])

        public final class Request: UserAPIRequest<Response> {

            public init() {
                super.init(service: CheckUserPhone.service)
            }
