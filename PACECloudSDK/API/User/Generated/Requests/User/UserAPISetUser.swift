...
extension UserAPI.User {
    ...
    */
    public enum SetUser {
        ...
        public static var service = UserAPIService<Response>(id: "SetUser", tag: "User", method: "PUT", path: "/users/{userId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:users:write"]), SecurityRequirement(type: "OIDC", scopes: ["user:users:write"])])
        ...
        public final class Request: UserAPIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: SetUser.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public var data: PCUserUser?

                public init(data: PCUserUser? = nil) {
                    self.data = data
                }
