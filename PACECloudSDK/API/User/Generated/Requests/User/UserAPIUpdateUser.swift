...
user record will be returned.
    */
    public enum UpdateUser {
        ...
        public static var service = UserAPIService<Response>(id: "UpdateUser", tag: "User", method: "PATCH", path: "/users/{userId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:users:write"]), SecurityRequirement(type: "OIDC", scopes: ["user:users:write"])])
