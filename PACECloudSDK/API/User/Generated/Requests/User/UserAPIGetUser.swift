...
extension UserAPI.User {
    ...
    public enum GetUser {
        ...
        public static var service = UserAPIService<Response>(id: "GetUser", tag: "User", method: "GET", path: "/users/{userId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:users:read"]), SecurityRequirement(type: "OIDC", scopes: ["user:users:read"])])
