...
extension UserAPI.User {
    ...
    */
    public enum DeleteUser {
        ...
        public static var service = UserAPIService<Response>(id: "DeleteUser", tag: "User", method: "DELETE", path: "/users/{userId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:users:delete"]), SecurityRequirement(type: "OIDC", scopes: ["user:users:delete"])])
