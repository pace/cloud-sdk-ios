...
An account OTP is required to perform the action.
    */
    public enum DeleteCurrentUser {

        public static var service = UserAPIService<Response>(id: "DeleteCurrentUser", tag: "User", method: "DELETE", path: "/user", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:user:delete"]), SecurityRequirement(type: "OIDC", scopes: ["user:user:delete"])])
