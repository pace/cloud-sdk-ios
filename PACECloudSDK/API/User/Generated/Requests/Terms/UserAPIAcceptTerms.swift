...
consent with the terms of service.
    */
    public enum AcceptTerms {
        ...
        public static var service = UserAPIService<Response>(id: "AcceptTerms", tag: "Terms", method: "POST", path: "/terms/{termsId}/accept", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:terms:accept"]), SecurityRequirement(type: "OIDC", scopes: ["user:terms:accept"])])
        ...
        public final class Request: UserAPIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AcceptTerms.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(termsId: ID? = nil) {
                let options = Options(termsId: termsId)
