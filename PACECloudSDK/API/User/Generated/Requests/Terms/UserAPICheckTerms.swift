...
In order to identify the user any oauth2 token must be passed.
    */
    public enum CheckTerms {

        public static var service = UserAPIService<Response>(id: "CheckTerms", tag: "Terms", method: "GET", path: "/terms/check", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: []), SecurityRequirement(type: "OIDC", scopes: [])])

        /** The name of the service */
        public enum PCUserFilterserviceName: String, Codable, Equatable, CaseIterable {
            case paceId = "PACE ID"
            case pACEConnectedFueling = "PACE Connected Fueling"
            case pACEPay = "PACE Pay"
            case pACECommunity = "PACE Community"
            case pACECarApp = "PACE Car App"
            case pACEDriveApp = "PACE Drive App"
        }
        ...
        public final class Request: UserAPIRequest<Response> {
            ...
            public struct Options {
                ...
                /** The name of the service */
                public var filterserviceName: PCUserFilterserviceName

                public var redirectUri: String?

                public init(filterserviceName: PCUserFilterserviceName, redirectUri: String? = nil) {
            ...
            public init(options: Options) {
                ...
                super.init(service: CheckTerms.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(filterserviceName: PCUserFilterserviceName, redirectUri: String? = nil) {
                let options = Options(filterserviceName: filterserviceName, redirectUri: redirectUri)
                self.init(options: options)
            }

            public override var queryParameters: [String: Any] {
                var params: [String: Any] = [:]
                params["filter[serviceName]"] = options.filterserviceName.encode()
