...
extension UserAPI.Credentials {
    ...
    */
    public enum CheckUserPinOrPassword {

        public static var service = UserAPIService<Response>(id: "CheckUserPinOrPassword", tag: "Credentials", method: "GET", path: "/user/pin-or-password", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:users.pin:check", "user:users.password:check"]), SecurityRequirement(type: "OIDC", scopes: ["user:users.pin:check", "user:users.password:check"])])

        public final class Request: UserAPIRequest<Response> {

            public init() {
                super.init(service: CheckUserPinOrPassword.service)
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public typealias SuccessType = PCUserPinOrPassword

            /** PIN or password is set */
            case status200(PCUserPinOrPassword)
            ...
            public var success: PCUserPinOrPassword? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(PCUserPinOrPassword.self, from: data))
