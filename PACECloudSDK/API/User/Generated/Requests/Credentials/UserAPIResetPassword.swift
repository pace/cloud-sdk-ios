...
If no recover pin is passed in the body user's payment methods will also be reset.
    */
    public enum ResetPassword {
        ...
        public static var service = UserAPIService<Response>(id: "ResetPassword", tag: "Credentials", method: "PUT", path: "/user/password/reset", hasBody: false, securityRequirements: [])
        ...
        public final class Request: UserAPIRequest<Response> {
            ...
            public convenience init(pin: String? = nil) {
                let options = Options(pin: pin)
