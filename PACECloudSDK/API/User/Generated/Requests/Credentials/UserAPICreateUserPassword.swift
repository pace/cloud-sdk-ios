...
extension UserAPI.Credentials {
    ...
    */
    public enum CreateUserPassword {

        public static var service = UserAPIService<Response>(id: "CreateUserPassword", tag: "Credentials", method: "PUT", path: "/user/password", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:users.password:create"]), SecurityRequirement(type: "OIDC", scopes: ["user:users.password:create"])])
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Password request received, confirmation pending. */
            case status202
 ...
 */
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                ...
                case 409: self = try .status409(decoder.decode(PCUserErrors.self, from: data))
