...
extension UserAPI.Credentials {
    ...
    */
    public enum CheckUserPassword {

        public static var service = UserAPIService<Response>(id: "CheckUserPassword", tag: "Credentials", method: "GET", path: "/user/password", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:users.password:check"]), SecurityRequirement(type: "OIDC", scopes: ["user:users.password:check"])])
        ...
        public final class Request: UserAPIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: CheckUserPassword.service)
            }
