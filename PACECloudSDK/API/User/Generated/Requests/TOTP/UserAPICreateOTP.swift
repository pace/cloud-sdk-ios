...
extension UserAPI.TOTP {
    ...
    */
    public enum CreateOTP {

        public static var service = UserAPIService<Response>(id: "CreateOTP", tag: "TOTP", method: "POST", path: "/user/otp", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:otp:create"]), SecurityRequirement(type: "OIDC", scopes: ["user:otp:create"])])

        public final class Request: UserAPIRequest<Response> {

            public var body: PCUserCreateOTPRequest

            public init(body: PCUserCreateOTPRequest, encoder: RequestEncoder? = nil) {
                self.body = body
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Valid OTP. */
            case status201(PCUserCreateOTP)
 ...
 */
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(PCUserCreateOTP.self, from: data))
