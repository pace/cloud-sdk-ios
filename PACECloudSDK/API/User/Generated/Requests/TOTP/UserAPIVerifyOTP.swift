...
extension UserAPI.TOTP {
    ...
    */
    public enum VerifyOTP {
        ...
        public static var service = UserAPIService<Response>(id: "VerifyOTP", tag: "TOTP", method: "POST", path: "/user/otp/verify", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:otp:verify"]), SecurityRequirement(type: "OIDC", scopes: ["user:otp:verify"])])
