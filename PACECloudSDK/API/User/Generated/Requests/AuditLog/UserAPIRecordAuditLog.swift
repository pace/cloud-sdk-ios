...
extension UserAPI.AuditLog {
    ...
    */
    public enum RecordAuditLog {

        public static var service = UserAPIService<Response>(id: "RecordAuditLog", tag: "AuditLog", method: "POST", path: "/auditlogs/record", hasBody: false, securityRequirements: [])
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public typealias SuccessType = PCUserAuditLogRecord

            /** Record accepted */
            case status204(PCUserAuditLogRecord)
            ...
            public var success: PCUserAuditLogRecord? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 204: self = try .status204(decoder.decode(PCUserAuditLogRecord.self, from: data))
