...
with any new keys, updating conflicting keys and leaving the rest untouched.
    */
    public enum SetUserAttributes {

        public static var service = UserAPIService<Response>(id: "SetUserAttributes", tag: "Attributes", method: "PUT", path: "/attributes", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:attributes:write"]), SecurityRequirement(type: "OIDC", scopes: ["user:attributes:write"])])
        ...
        public final class Request: UserAPIRequest<Response> {
            ...
            public init(body: [String: Any], encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: SetUserAttributes.service) { defaultEncoder in
