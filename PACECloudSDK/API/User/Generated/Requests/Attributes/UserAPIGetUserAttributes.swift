...
the required scope.
    */
    public enum GetUserAttributes {

        public static var service = UserAPIService<Response>(id: "GetUserAttributes", tag: "Attributes", method: "GET", path: "/attributes", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["user:attributes:read"]), SecurityRequirement(type: "OIDC", scopes: ["user:attributes:read"])])

        public final class Request: UserAPIRequest<Response> {

            public init() {
                super.init(service: GetUserAttributes.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Retrieves the persisted attributes */
