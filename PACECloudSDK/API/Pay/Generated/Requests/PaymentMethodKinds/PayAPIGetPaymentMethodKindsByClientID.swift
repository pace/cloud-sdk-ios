...
extension PayAPI.PaymentMethodKinds {
    ...
    */
    public enum GetPaymentMethodKindsByClientID {

        public static var service = PayAPIService<Response>(id: "GetPaymentMethodKindsByClientID", tag: "Payment Method Kinds", method: "GET", path: "/payment-method-kinds/{clientId}", hasBody: false, securityRequirements: [])
        ...
        public final class Request: PayAPIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(clientId: String, acceptLanguage: String? = nil, additionalData: Bool? = nil, poiID: ID? = nil) {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetPaymentMethodKindsByClientID.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(clientId: String, acceptLanguage: String? = nil, additionalData: Bool? = nil, poiID: ID? = nil) {
                let options = Options(clientId: clientId, acceptLanguage: acceptLanguage, additionalData: additionalData, poiID: poiID)
