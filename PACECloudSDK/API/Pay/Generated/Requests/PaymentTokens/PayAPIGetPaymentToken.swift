...
extension PayAPI.PaymentTokens {
    ...
    public enum GetPaymentToken {
        ...
        public static var service = PayAPIService<Response>(id: "GetPaymentToken", tag: "Payment Tokens", method: "GET", path: "/payment-tokens/{paymentTokenId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["pay:payment-tokens:read"]), SecurityRequirement(type: "OIDC", scopes: ["pay:payment-tokens:read"])])
        ...
        public final class Request: PayAPIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetPaymentToken.service)
            }
