...
PaymentSession that can be used to obtain the applePay payload.
    */
    public enum AuthorizeApplePayPaymentToken {
        ...
        public static var service = PayAPIService<Response>(id: "AuthorizeApplePayPaymentToken", tag: "Payment Tokens", method: "POST", path: "/payment-method-kinds/applepay/authorize", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["pay:payment-tokens:create"]), SecurityRequirement(type: "OIDC", scopes: ["pay:payment-tokens:create"])])
