...
to create the `googlePay` specific authorization data.
    */
    public enum AuthorizeGooglePayPaymentToken {

        public static var service = PayAPIService<Response>(id: "AuthorizeGooglePayPaymentToken", tag: "Payment Tokens", method: "POST", path: "/payment-method-kinds/googlepay/authorize", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["pay:payment-tokens:create"]), SecurityRequirement(type: "OIDC", scopes: ["pay:payment-tokens:create"])])
        ...
        public final class Request: PayAPIRequest<Response> {
            ...
            public class Body: APIModel {
                ...
                public var data: PCPayPaymentTokenCreateGooglePayRequest?

                public init(data: PCPayPaymentTokenCreateGooglePayRequest? = nil) {
                    self.data = data
                }
            ...
            public init(body: Body, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: AuthorizeGooglePayPaymentToken.service) { defaultEncoder in
 ...
 */
            ...
            /** Payment information cannot be resolved with Google Pay.
 */
