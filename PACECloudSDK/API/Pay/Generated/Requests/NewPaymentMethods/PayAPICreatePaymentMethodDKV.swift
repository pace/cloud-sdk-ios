...
The payment method ID is optional when posting data.
    */
    public enum CreatePaymentMethodDKV {
        ...
        public static var service = PayAPIService<Response>(id: "CreatePaymentMethodDKV", tag: "New Payment Methods", method: "POST", path: "/payment-methods/dkv", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["pay:payment-methods:create"]), SecurityRequirement(type: "OIDC", scopes: ["pay:payment-methods:create"])])
        ...
        public final class Request: PayAPIRequest<Response> {
            ...
            public init(body: Body, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: CreatePaymentMethodDKV.service) { defaultEncoder in
