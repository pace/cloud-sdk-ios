...
This payment method only works on *test environments* and is *reserved for testing purposes*.
    */
    public enum CreatePaymentMethodPACECardSandbox {

        public static var service = PayAPIService<Response>(id: "CreatePaymentMethodPACECardSandbox", tag: "New Payment Methods", method: "POST", path: "/payment-methods/pacecardsandbox", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["pay:payment-methods:create"]), SecurityRequirement(type: "OIDC", scopes: ["pay:payment-methods:create"])])
