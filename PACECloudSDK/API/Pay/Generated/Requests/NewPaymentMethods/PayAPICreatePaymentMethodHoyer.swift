...
The payment method ID is optional when posting data.
    */
    public enum CreatePaymentMethodHoyer {
        ...
        public static var service = PayAPIService<Response>(id: "CreatePaymentMethodHoyer", tag: "New Payment Methods", method: "POST", path: "/payment-methods/hoyer", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["pay:payment-methods:create"]), SecurityRequirement(type: "OIDC", scopes: ["pay:payment-methods:create"])])
        ...
        public final class Request: PayAPIRequest<Response> {
            ...
            public class Body: APIModel {
                ...
                public var data: PCPayPaymentMethodHoyerCreateRequest?

                public init(data: PCPayPaymentMethodHoyerCreateRequest? = nil) {
                    self.data = data
                }
            ...
            public init(body: Body, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: CreatePaymentMethodHoyer.service) { defaultEncoder in
