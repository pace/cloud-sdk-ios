...
The payment method ID is optional when posting data.
    */
    public enum CreatePaymentMethodTFCSandbox {

        public static var service = PayAPIService<Response>(id: "CreatePaymentMethodTFCSandbox", tag: "New Payment Methods", method: "POST", path: "/payment-methods/tfcsandbox", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["pay:payment-methods:create"]), SecurityRequirement(type: "OIDC", scopes: ["pay:payment-methods:create"])])
        ...
        public final class Request: PayAPIRequest<Response> {
            ...
            public class Body: APIModel {
                ...
                public var data: PCPayPaymentMethodTFCSandboxCreateRequest?

                public init(data: PCPayPaymentMethodTFCSandboxCreateRequest? = nil) {
                    self.data = data
                }
            ...
            public init(body: Body, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: CreatePaymentMethodTFCSandbox.service) { defaultEncoder in
