...
The payment method ID is optional when posting data.
    */
    public enum CreatePaymentMethodLogpaysandbox {

        public static var service = PayAPIService<Response>(id: "CreatePaymentMethodLogpaysandbox", tag: "New Payment Methods", method: "POST", path: "/payment-methods/logpaysandbox", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["pay:payment-methods:create"]), SecurityRequirement(type: "OIDC", scopes: ["pay:payment-methods:create"])])
        ...
        public final class Request: PayAPIRequest<Response> {
            ...
            public class Body: APIModel {
                ...
                public var data: PCPayPaymentMethodLogpaysandboxCreateRequest?

                public init(data: PCPayPaymentMethodLogpaysandboxCreateRequest? = nil) {
                    self.data = data
                }
            ...
            public init(body: Body, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: CreatePaymentMethodLogpaysandbox.service) { defaultEncoder in
