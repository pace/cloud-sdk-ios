...
Registering giropay as payment method is a 2-step process, thus the payment method will only be created after the user approved it on the PayDirekt website. The approval URL in the response will point you to the correct page. After the user takes action the user is redirected to one of the three redirect URLs provided by you.
    */
    public enum CreatePaymentMethodGiropay {

        public static var service = PayAPIService<Response>(id: "CreatePaymentMethodGiropay", tag: "New Payment Methods", method: "POST", path: "/payment-methods/giropay", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["pay:payment-methods:create"]), SecurityRequirement(type: "OIDC", scopes: ["pay:payment-methods:create"])])
        ...
        public final class Request: PayAPIRequest<Response> {
            ...
            public init(body: Body, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: CreatePaymentMethodGiropay.service) { defaultEncoder in
