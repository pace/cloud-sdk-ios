...
The payment method ID is optional when posting data.
    */
    public enum CreatePaymentMethodTFC {

        public static var service = PayAPIService<Response>(id: "CreatePaymentMethodTFC", tag: "New Payment Methods", method: "POST", path: "/payment-methods/tfc", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["pay:payment-methods:create"]), SecurityRequirement(type: "OIDC", scopes: ["pay:payment-methods:create"])])
        ...
        public final class Request: PayAPIRequest<Response> {
            ...
            public class Body: APIModel {
                ...
                public var data: PCPayPaymentMethodTFCCreateRequest?

                public init(data: PCPayPaymentMethodTFCCreateRequest? = nil) {
                    self.data = data
                }
            ...
            public init(body: Body, encoder: RequestEncoder? = nil) {
                self.body = body
                super.init(service: CreatePaymentMethodTFC.service) { defaultEncoder in
