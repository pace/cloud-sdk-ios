...
extension PayAPI.FleetPaymentMethods {
    ...
    public enum GetFleetPaymentMethod {

        public static var service = PayAPIService<Response>(id: "GetFleetPaymentMethod", tag: "Fleet Payment Methods", method: "GET", path: "/fleet/payment-methods/{paymentMethodId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["pay:payment-methods:read:one"]), SecurityRequirement(type: "OIDC", scopes: ["pay:payment-methods:read:one"])])
        ...
        public final class Request: PayAPIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetFleetPaymentMethod.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public var data: PCPayFleetPaymentMethod?

                public init(data: PCPayFleetPaymentMethod? = nil) {
                    self.data = data
                }
