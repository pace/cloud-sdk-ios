...
extension PayAPI.PaymentTransactions {
    ...
    */
    public enum ListTransactionsForContractID {

        public static var service = PayAPIService<Response>(id: "ListTransactionsForContractID", tag: "Payment Transactions", method: "GET", path: "/transactions/contracts/{contractID}", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["pay:transactions:{contractID}:read"])])
        ...
        public final class Request: PayAPIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(contractID: String, pagenumber: Int? = nil, pagesize: Int? = nil, dateFrom: DateTime, dateTo: DateTime) {
            ...
            public init(options: Options) {
                ...
                super.init(service: ListTransactionsForContractID.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(contractID: String, pagenumber: Int? = nil, pagesize: Int? = nil, dateFrom: DateTime, dateTo: DateTime) {
                let options = Options(contractID: contractID, pagenumber: pagenumber, pagesize: pagesize, dateFrom: dateFrom, dateTo: dateTo)
                self.init(options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "contractID" + "}", with: "\(self.options.contractID)")
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** List of transactions for  given contractID within  given time frame */
