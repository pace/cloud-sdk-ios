...
extension PayAPI.PaymentTransactions {
    ...
    /**
    List transactions for JET

    List all transactions for JET within the given time frame.
    */
    public enum ListTransactionsForJET {

        public static var service = PayAPIService<Response>(id: "ListTransactionsForJET", tag: "Payment Transactions", method: "GET", path: "/transactions/contracts/partners/jet", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["pay:transactions:jet:read"])])
        ...
        public final class Request: PayAPIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(pagenumber: Int? = nil, pagesize: Int? = nil, dateFrom: DateTime, dateTo: DateTime) {
            ...
            public init(options: Options) {
                ...
                super.init(service: ListTransactionsForJET.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(pagenumber: Int? = nil, pagesize: Int? = nil, dateFrom: DateTime, dateTo: DateTime) {
                let options = Options(pagenumber: pagenumber, pagesize: pagesize, dateFrom: dateFrom, dateTo: dateTo)
            ...
            public override var queryParameters: [String: Any] {
                ...
                params["date_from"] = options.dateFrom.encode()
                params["date_to"] = options.dateTo.encode()
                return params
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public var data: PCPayTransactionsShort?

                public var meta: PCPayPagingMeta?

                public init(data: PCPayTransactionsShort? = nil, meta: PCPayPagingMeta? = nil) {
                    self.data = data
                    self.meta = meta
                }
            ...
            /** List of transactions for JET within the given time frame. */
