...
extension PayAPI.PaymentTransactions {
    ...
    */
    public enum ResendReceipt {

        public static var service = PayAPIService<Response>(id: "ResendReceipt", tag: "Payment Transactions", method: "POST", path: "/receipts/resend", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["pay:transactions:receipt"]), SecurityRequirement(type: "OIDC", scopes: ["pay:transactions:receipt"])])
        ...
        public final class Request: PayAPIRequest<Response> {
            ...
            public class Body: APIModel {
                ...
                public var data: PCPayTransactionIDListRequest?

                public init(data: PCPayTransactionIDListRequest? = nil) {
                    self.data = data
                }
 ...
 */
            ...
            public init(body: Body, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: ResendReceipt.service) { defaultEncoder in
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Receipt(s) was/were sent again by mail. */
            case status200
