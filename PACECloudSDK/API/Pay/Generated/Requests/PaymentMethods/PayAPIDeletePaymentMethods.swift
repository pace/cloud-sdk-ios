...
extension PayAPI.PaymentMethods {
    ...
    */
    public enum DeletePaymentMethods {

        public static var service = PayAPIService<Response>(id: "DeletePaymentMethods", tag: "Payment Methods", method: "DELETE", path: "/payment-methods", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["pay:payment-methods:delete"]), SecurityRequirement(type: "OIDC", scopes: ["pay:payment-methods:delete"])])
