...
public class PayAPIClient {
    ...
    private func validateNetworkRequest<T>(request: PayAPIRequest<T>,
                                           urlRequest: URLRequest,
...
public extension PayAPIClient {
    ...
    func makeRequest<T>(_ request: PayAPIRequest<T>,
                        behaviours: [PayAPIRequestBehaviour] = [],
                        currentUnauthorizedRetryCount: Int = 0,
                        currentRetryCount: Int = 0) async -> PayAPIResponse<T> {
