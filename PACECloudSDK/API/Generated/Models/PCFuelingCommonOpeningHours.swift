...
public class PCFuelingCommonOpeningHours: APIModel {
    ...
    public class Rules: APIModel {
        ...
        public enum PCFuelingAction: String, Codable, Equatable, CaseIterable {
            case `open` = "open"
            case close = "close"
        }

        public enum PCFuelingDays: String, Codable, Equatable, CaseIterable {
            case monday = "monday"
        ...
        public var action: PCFuelingAction?

        public var days: [PCFuelingDays]?
        ...
        public init(action: PCFuelingAction? = nil, days: [PCFuelingDays]? = nil, timespans: [Timespans]? = nil) {
            self.action = action
            self.days = days
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCFuelingCommonOpeningHours else { return false }
      guard self.rules == object.rules else { return false }
      guard self.timezone == object.timezone else { return false }
      return true
    }

    public static func == (lhs: PCFuelingCommonOpeningHours, rhs: PCFuelingCommonOpeningHours) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
