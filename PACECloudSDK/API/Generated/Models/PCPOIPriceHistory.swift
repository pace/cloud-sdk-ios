...
public class PCPOIPriceHistory: APIModel {
    ...
    public init(id: String? = nil, type: PCPOIType? = nil, currency: String? = nil, from: DateTime? = nil, fuelPrices: [FuelPrices]? = nil, productName: String? = nil, to: DateTime? = nil) {
        self.id = id
        self.type = type
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPOIPriceHistory else { return false }
    ...
    public static func == (lhs: PCPOIPriceHistory, rhs: PCPOIPriceHistory) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
