...
public class PCUserUserPINAndOTPRequest: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCUserUserPINAndOTPRequest else { return false }
    ...
    public static func == (lhs: PCUserUserPINAndOTPRequest, rhs: PCUserUserPINAndOTPRequest) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
