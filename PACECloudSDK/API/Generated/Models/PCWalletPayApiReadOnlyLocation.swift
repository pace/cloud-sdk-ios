...
public class PCWalletPayApiReadOnlyLocation: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCWalletPayApiReadOnlyLocation else { return false }
    ...
    public static func == (lhs: PCWalletPayApiReadOnlyLocation, rhs: PCWalletPayApiReadOnlyLocation) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
