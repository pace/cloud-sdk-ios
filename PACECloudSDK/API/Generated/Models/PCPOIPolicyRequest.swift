...
public class PCPOIPolicyRequest: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPOIPolicyRequest else { return false }
    ...
    public static func == (lhs: PCPOIPolicyRequest, rhs: PCPOIPolicyRequest) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
