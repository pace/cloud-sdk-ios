...
public class PCPayFleetPaymentMethod: APIModel {
 ...
 */
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPayFleetPaymentMethod else { return false }
    ...
    public static func == (lhs: PCPayFleetPaymentMethod, rhs: PCPayFleetPaymentMethod) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
