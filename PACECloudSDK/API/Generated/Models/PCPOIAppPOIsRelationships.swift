...
public class PCPOIAppPOIsRelationships: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPOIAppPOIsRelationships else { return false }
      guard self.data == object.data else { return false }
      return true
    }

    public static func == (lhs: PCPOIAppPOIsRelationships, rhs: PCPOIAppPOIsRelationships) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
