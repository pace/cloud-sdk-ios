...
public class PCPayPaymentMethodPayPalCreate: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPayPaymentMethodPayPalCreate else { return false }
    ...
    public static func == (lhs: PCPayPaymentMethodPayPalCreate, rhs: PCPayPaymentMethodPayPalCreate) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
