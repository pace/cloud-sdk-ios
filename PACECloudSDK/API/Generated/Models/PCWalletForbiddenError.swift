...
/** Use this error when a client that is authenticated is trying
to access a specific route/resource but does not have the
required permissions to do so. This might be the case when
a scope is missing. */
public class PCWalletForbiddenError: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCWalletForbiddenError else { return false }
    ...
    public static func == (lhs: PCWalletForbiddenError, rhs: PCWalletForbiddenError) -> Bool {
