...
public class PCPayPaymentMethodTFCCreateRequest: APIModel {
     ...
     */
        ...
        public init(kind: PCPayKind, cardNumber: String? = nil, expiry: String? = nil, managed: Bool? = nil, pin: String? = nil) {
            self.kind = kind
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPayPaymentMethodTFCCreateRequest else { return false }
    ...
    public static func == (lhs: PCPayPaymentMethodTFCCreateRequest, rhs: PCPayPaymentMethodTFCCreateRequest) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
