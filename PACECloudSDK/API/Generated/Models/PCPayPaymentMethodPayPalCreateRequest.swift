...
public class PCPayPaymentMethodPayPalCreateRequest: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPayPaymentMethodPayPalCreateRequest else { return false }
    ...
    public static func == (lhs: PCPayPaymentMethodPayPalCreateRequest, rhs: PCPayPaymentMethodPayPalCreateRequest) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
