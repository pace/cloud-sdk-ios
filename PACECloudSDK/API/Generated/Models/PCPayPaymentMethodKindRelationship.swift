...
public class PCPayPaymentMethodKindRelationship: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPayPaymentMethodKindRelationship else { return false }
      guard self.data == object.data else { return false }
      return true
    }

    public static func == (lhs: PCPayPaymentMethodKindRelationship, rhs: PCPayPaymentMethodKindRelationship) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
