...
public class PCPOIPolicyRulePriority: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPOIPolicyRulePriority else { return false }
      guard self.sourceId == object.sourceId else { return false }
      guard self.timeToLive == object.timeToLive else { return false }
      return true
    }

    public static func == (lhs: PCPOIPolicyRulePriority, rhs: PCPOIPolicyRulePriority) -> Bool {
