...
public class PCPOIDedupeRequest: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPOIDedupeRequest else { return false }
    ...
    public static func == (lhs: PCPOIDedupeRequest, rhs: PCPOIDedupeRequest) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
