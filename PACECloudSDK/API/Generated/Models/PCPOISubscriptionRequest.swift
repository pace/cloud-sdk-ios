...
public class PCPOISubscriptionRequest: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPOISubscriptionRequest else { return false }
    ...
    public static func == (lhs: PCPOISubscriptionRequest, rhs: PCPOISubscriptionRequest) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
