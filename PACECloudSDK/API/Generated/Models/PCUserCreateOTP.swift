...
public class PCUserCreateOTP: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCUserCreateOTP else { return false }
    ...
    public static func == (lhs: PCUserCreateOTP, rhs: PCUserCreateOTP) -> Bool {
