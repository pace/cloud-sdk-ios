...
/** Use this error when a client is requesting a resource but no matching
resource was found. */
public class PCWalletResourceNotFoundError: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCWalletResourceNotFoundError else { return false }
    ...
    public static func == (lhs: PCWalletResourceNotFoundError, rhs: PCWalletResourceNotFoundError) -> Bool {
