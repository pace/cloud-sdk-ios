...
public class PCPayPaymentMethodRequest: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPayPaymentMethodRequest else { return false }
    ...
    public static func == (lhs: PCPayPaymentMethodRequest, rhs: PCPayPaymentMethodRequest) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
