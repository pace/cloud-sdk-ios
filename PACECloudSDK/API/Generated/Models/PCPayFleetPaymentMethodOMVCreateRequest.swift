...
public class PCPayFleetPaymentMethodOMVCreateRequest: APIModel {
    ...
    public class Attributes: APIModel {
        ...
        public init(kind: PCPayKind, pan: String, userId: ID, expiry: String? = nil, managed: Bool? = nil, track1: String? = nil, track2: String? = nil) {
            self.kind = kind
            self.pan = pan
            self.userId = userId
            self.expiry = expiry
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPayFleetPaymentMethodOMVCreateRequest else { return false }
    ...
    public static func == (lhs: PCPayFleetPaymentMethodOMVCreateRequest, rhs: PCPayFleetPaymentMethodOMVCreateRequest) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
