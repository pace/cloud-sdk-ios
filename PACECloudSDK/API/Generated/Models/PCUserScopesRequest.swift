...
public class PCUserScopesRequest: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCUserScopesRequest else { return false }
    ...
    public static func == (lhs: PCUserScopesRequest, rhs: PCUserScopesRequest) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
