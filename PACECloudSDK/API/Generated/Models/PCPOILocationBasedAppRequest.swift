...
public class PCPOILocationBasedAppRequest: APIModel {
     ...
     */
        ...
        public init(androidInstantAppUrl: String? = nil, appType: PCPOIAppType? = nil, cache: PCPOICache? = nil, createdAt: DateTime? = nil, deletedAt: DateTime? = nil, logoUrl: String? = nil, pwaUrl: String? = nil, subtitle: String? = nil, title: String? = nil, updatedAt: DateTime? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPOILocationBasedAppRequest else { return false }
    ...
    public static func == (lhs: PCPOILocationBasedAppRequest, rhs: PCPOILocationBasedAppRequest) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
