 ...
 */
    ...
    public init(id: ID? = nil, type: PCPOIType? = nil, androidInstantAppUrl: String? = nil, appType: PCPOIAppType? = nil, cache: PCPOICache? = nil, createdAt: DateTime? = nil, deletedAt: DateTime? = nil, logoUrl: String? = nil, pwaUrl: String? = nil, subtitle: String? = nil, title: String? = nil, updatedAt: DateTime? = nil) {
        self.id = id
        self.type = type
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPOILocationBasedApp else { return false }
