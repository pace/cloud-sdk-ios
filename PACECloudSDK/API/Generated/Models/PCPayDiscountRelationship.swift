...
public class PCPayDiscountRelationship: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPayDiscountRelationship else { return false }
      guard self.data == object.data else { return false }
      return true
    }

    public static func == (lhs: PCPayDiscountRelationship, rhs: PCPayDiscountRelationship) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
