...
public class PCPOISourceRequest: APIModel {
    ...
    public class Attributes: APIModel {
        ...
        public init(countries: [String]? = nil, createdAt: DateTime? = nil, lastDataAt: DateTime? = nil, name: String? = nil, poiType: PCPOIPOIType? = nil, schema: [PCPOIFieldName]? = nil, updatedAt: DateTime? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPOISourceRequest else { return false }
    ...
    public static func == (lhs: PCPOISourceRequest, rhs: PCPOISourceRequest) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
