...
public class PCPayPaymentMethodLogpayCreate: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPayPaymentMethodLogpayCreate else { return false }
    ...
    public static func == (lhs: PCPayPaymentMethodLogpayCreate, rhs: PCPayPaymentMethodLogpayCreate) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
