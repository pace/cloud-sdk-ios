...
public class PCPayPaymentMethodTFCSandboxCreateRequest: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPayPaymentMethodTFCSandboxCreateRequest else { return false }
    ...
    public static func == (lhs: PCPayPaymentMethodTFCSandboxCreateRequest, rhs: PCPayPaymentMethodTFCSandboxCreateRequest) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
