...
public class PCPayPaymentMethodDKVCreateRequest: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPayPaymentMethodDKVCreateRequest else { return false }
    ...
    public static func == (lhs: PCPayPaymentMethodDKVCreateRequest, rhs: PCPayPaymentMethodDKVCreateRequest) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
