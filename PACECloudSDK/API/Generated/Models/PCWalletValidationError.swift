...
/** Use this error if the request contains invalid parameters in
either the request bodym headers or path/query string parameters. */
public class PCWalletValidationError: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCWalletValidationError else { return false }
    ...
    public static func == (lhs: PCWalletValidationError, rhs: PCWalletValidationError) -> Bool {
