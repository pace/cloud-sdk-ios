...
public class PCPOIPOIRequest: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPOIPOIRequest else { return false }
    ...
    public static func == (lhs: PCPOIPOIRequest, rhs: PCPOIPOIRequest) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
