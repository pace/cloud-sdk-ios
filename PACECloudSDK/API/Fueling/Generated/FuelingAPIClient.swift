...
public class FuelingAPIClient {
    ...
    @discardableResult
    public func makeRequest<T>(_ request: FuelingAPIRequest<T>,
                               behaviours: [FuelingAPIRequestBehaviour] = [],
                               currentUnauthorizedRetryCount: Int = 0,
                               currentRetryCount: Int = 0,
                               completionQueue: DispatchQueue = DispatchQueue.main,
                               complete: @escaping (FuelingAPIResponse<T>) -> Void) -> CancellableFuelingAPIRequest? {
    ...
    private func performRequest<T>(request: FuelingAPIRequest<T>,
                                   urlRequest: URLRequest,
                                   cancellableRequest: CancellableFuelingAPIRequest,
                                   requestBehaviour: FuelingAPIRequestBehaviourGroup,
                                   currentUnauthorizedRetryCount: Int,
                                   currentRetryCount: Int,
                                   completionQueue: DispatchQueue,
                                   complete: @escaping (FuelingAPIResponse<T>) -> Void) -> URLSessionDataTask {
...
public extension FuelingAPIClient {
    ...
    func makeRequest<T>(_ request: FuelingAPIRequest<T>,
                        behaviours: [FuelingAPIRequestBehaviour] = [],
                        currentUnauthorizedRetryCount: Int = 0,
                        currentRetryCount: Int = 0) async -> FuelingAPIResponse<T> {
