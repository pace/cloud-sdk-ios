...
Only use after approaching, otherwise returns `403 Forbidden`.
    */
    public enum WaitOnPumpStatusChange {
        ...
        public static var service = FuelingAPIService<Response>(id: "WaitOnPumpStatusChange", tag: "Fueling", method: "GET", path: "/gas-stations/{gasStationId}/pumps/{pumpId}/wait-for-status-change", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["fueling:pumps:read"]), SecurityRequirement(type: "OIDC", scopes: ["fueling:pumps:read"])])
        ...
        public final class Request: FuelingAPIRequest<Response> {
            ...
            public struct Options {
                ...
                /** Use **long polling** for status updates */
                public var update: PCFuelingUpdate?

                /** Pump status */
                public var lastStatus: PCFuelingLastStatus?

                /** Timeout in seconds */
                public var timeout: Int?

                public init(gasStationId: ID, pumpId: ID, update: PCFuelingUpdate? = nil, lastStatus: PCFuelingLastStatus? = nil, timeout: Int? = nil) {
            ...
            public init(options: Options) {
                ...
                super.init(service: WaitOnPumpStatusChange.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(gasStationId: ID, pumpId: ID, update: PCFuelingUpdate? = nil, lastStatus: PCFuelingLastStatus? = nil, timeout: Int? = nil) {
                let options = Options(gasStationId: gasStationId, pumpId: pumpId, update: update, lastStatus: lastStatus, timeout: timeout)
            ...
            public override var queryParameters: [String: Any] {
                ...
                if let lastStatus = options.lastStatus?.encode() {
