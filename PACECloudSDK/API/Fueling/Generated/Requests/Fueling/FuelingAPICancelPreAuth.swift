...
Cancel an unattended payment process. This will only work if the payment was not already captured. Returns `404 Not Found` in case the unattended payment already went through.
    */
    public enum CancelPreAuth {
        ...
        public static var service = FuelingAPIService<Response>(id: "CancelPreAuth", tag: "Fueling", method: "DELETE", path: "/gas-stations/{gasStationId}/transactions/{transactionId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["fueling:transactions:delete"]), SecurityRequirement(type: "OIDC", scopes: ["fueling:transactions:delete"])])
        ...
        public final class Request: FuelingAPIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(gasStationId: ID, transactionId: ID) {
            ...
            public init(options: Options) {
                ...
                super.init(service: CancelPreAuth.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(gasStationId: ID, transactionId: ID) {
                let options = Options(gasStationId: gasStationId, transactionId: transactionId)
