...
Only use after approaching, otherwise returns `403 Forbidden`.
    */
    public enum GetPumps {
        ...
        public static var service = FuelingAPIService<Response>(id: "GetPumps", tag: "Fueling", method: "GET", path: "/gas-stations/{gasStationId}/pumps", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["fueling:pumps:read"]), SecurityRequirement(type: "OIDC", scopes: ["fueling:pumps:read"])])
        ...
        public final class Request: FuelingAPIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetPumps.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public init(data: PCFuelingGetPumpsResponse? = nil) {
                    self.data = data
                }
