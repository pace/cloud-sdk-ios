...
* `carFuelType` may be provided but has no effect.
    */
    public enum ProcessPayment {
        ...
        public static var service = FuelingAPIService<Response>(id: "ProcessPayment", tag: "Fueling", method: "POST", path: "/gas-stations/{gasStationId}/transactions", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["fueling:transactions:create"]), SecurityRequirement(type: "OIDC", scopes: ["fueling:transactions:create"])])
