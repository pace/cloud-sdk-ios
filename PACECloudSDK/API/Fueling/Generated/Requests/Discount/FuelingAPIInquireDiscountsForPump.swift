...
Only use this if the pump status is ready to pay, otherwise returns `403 Forbidden`.
    */
    public enum InquireDiscountsForPump {

        public static var service = FuelingAPIService<Response>(id: "InquireDiscountsForPump", tag: "Discount", method: "POST", path: "/gas-stations/{gasStationId}/pumps/{pumpId}/discounts", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["fueling:discounts:inquiry"]), SecurityRequirement(type: "OIDC", scopes: ["fueling:discounts:inquiry"])])
        ...
        public final class Request: FuelingAPIRequest<Response> {
            ...
            public class Body: APIModel {
                ...
                public var data: PCFuelingDiscountInquiryRequest?

                public init(data: PCFuelingDiscountInquiryRequest? = nil) {
                    self.data = data
                }
            ...
            public struct Options {
                ...
                public init(gasStationId: ID, pumpId: ID) {
            ...
            public init(body: Body, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: InquireDiscountsForPump.service) { defaultEncoder in
            ...
            public convenience init(gasStationId: ID, pumpId: ID, body: Body) {
                let options = Options(gasStationId: gasStationId, pumpId: pumpId)
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public var data: PCFuelingDiscounts?

                public init(data: PCFuelingDiscounts? = nil) {
                    self.data = data
                }
