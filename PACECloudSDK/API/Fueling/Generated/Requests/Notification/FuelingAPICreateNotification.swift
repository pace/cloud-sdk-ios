...
extension FuelingAPI.Notification {
  ...
  * `400` is returned in case the vendor format is not valid when comparing against the provided input (request body)
    */
    public enum CreateNotification {
        ...
        public static var service = FuelingAPIService<Response>(id: "CreateNotification", tag: "Notification", method: "POST", path: "/notifications", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["fueling:notifications:create"]), SecurityRequirement(type: "OIDC", scopes: ["fueling:notifications:create"])])
        ...
        public final class Request: FuelingAPIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: CreateNotification.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(vendor: String? = nil) {
                let options = Options(vendor: vendor)
                self.init(options: options)
            }

            public override var queryParameters: [String: Any] {
                var params: [String: Any] = [:]
                if let vendor = options.vendor {
