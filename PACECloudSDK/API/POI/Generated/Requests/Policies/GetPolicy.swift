...
extension POIAPI.Policies {
    ...
    public enum GetPolicy {
        ...
        public static let service = APIService<Response>(id: "GetPolicy", tag: "Policies", method: "GET", path: "/beta/policies/{policyId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["poi:policies:read"]), SecurityRequirement(type: "OIDC", scopes: ["poi:policies:read"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                /** ID of the policy */
                public var policyId: ID?

                public init(policyId: ID? = nil) {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetPolicy.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(policyId: ID? = nil) {
                let options = Options(policyId: policyId)
