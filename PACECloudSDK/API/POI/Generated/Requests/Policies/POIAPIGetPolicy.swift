...
extension POIAPI.Policies {
    ...
    public enum GetPolicy {
        ...
        public static var service = POIAPIService<Response>(id: "GetPolicy", tag: "Policies", method: "GET", path: "/policies/{policyId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["poi:policies:read"]), SecurityRequirement(type: "OIDC", scopes: ["poi:policies:read"])])
