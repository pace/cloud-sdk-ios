...
extension POIAPI.Apps {
    ...
    public enum CreateApp {
        ...
        public static let service = APIService<Response>(id: "CreateApp", tag: "Apps", method: "POST", path: "/beta/apps", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["poi:apps:create"]), SecurityRequirement(type: "OIDC", scopes: ["poi:apps:create"])])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: CreateApp.service)
            }
        }
