...
In case the query returns a `404` (`Not Found`) the app was deleted and should be deleted from any caches.
    */
    public enum GetApp {
        ...
        public static let service = APIService<Response>(id: "GetApp", tag: "Apps", method: "GET", path: "/beta/apps/{appID}", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["poi:apps:read"]), SecurityRequirement(type: "OIDC", scopes: ["poi:apps:read"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetApp.service)
            }
