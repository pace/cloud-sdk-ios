...
extension POIAPI.Apps {
    ...
    public enum CreateApp {
        ...
        public static var service = POIAPIService<Response>(id: "CreateApp", tag: "Apps", method: "POST", path: "/apps", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["poi:apps:create"]), SecurityRequirement(type: "OIDC", scopes: ["poi:apps:create"])])
