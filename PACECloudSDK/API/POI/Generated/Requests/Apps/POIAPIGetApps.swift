 ...
 */
            ...
            public init(options: Options) {
                ...
                super.init(service: GetApps.service)
            }
            ...
            public override var queryParameters: [String: Any] {
                ...
                if let filtercache = options.filtercache?.encode() {
                  params["filter[cache]"] = filtercache
                }
                if let filtersince = options.filtersince?.encode() {
                  params["filter[since]"] = filtersince
                }
                return params
            }
