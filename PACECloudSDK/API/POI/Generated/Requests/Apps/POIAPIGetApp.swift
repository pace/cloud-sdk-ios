...
In case the query returns a `404` (`Not Found`) the app was deleted and should be deleted from any caches.
    */
    public enum GetApp {
        ...
        public static var service = POIAPIService<Response>(id: "GetApp", tag: "Apps", method: "GET", path: "/apps/{appID}", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["poi:apps:read"]), SecurityRequirement(type: "OIDC", scopes: ["poi:apps:read"])])
