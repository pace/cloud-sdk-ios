...
extension POIAPI.Apps {
    ...
    public enum UpdateApp {
        ...
        public static let service = APIService<Response>(id: "UpdateApp", tag: "Apps", method: "PUT", path: "/beta/apps/{appID}", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["poi:apps:update"]), SecurityRequirement(type: "OIDC", scopes: ["poi:apps:update"])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: UpdateApp.service)
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public var data: PCLocationBasedApp?

                public init(data: PCLocationBasedApp? = nil) {
                    self.data = data
                }
