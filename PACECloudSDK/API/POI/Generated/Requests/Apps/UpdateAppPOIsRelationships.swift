...
extension POIAPI.Apps {
    ...
    public enum UpdateAppPOIsRelationships {
        ...
        public static let service = APIService<Response>(id: "UpdateAppPOIsRelationships", tag: "Apps", method: "PATCH", path: "/beta/apps/{appID}/relationships/pois", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["poi:apps:update"]), SecurityRequirement(type: "OIDC", scopes: ["poi:apps:update"])])
