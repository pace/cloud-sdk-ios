...
extension POIAPI.Sources {
    ...
    public enum UpdateSource {
        ...
        public static let service = APIService<Response>(id: "UpdateSource", tag: "Sources", method: "PUT", path: "/beta/sources/{sourceId}", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["poi:sources:update"]), SecurityRequirement(type: "OIDC", scopes: ["poi:sources:update"])])
