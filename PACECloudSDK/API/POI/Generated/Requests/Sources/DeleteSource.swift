...
extension POIAPI.Sources {
    ...
    public enum DeleteSource {
        ...
        public static let service = APIService<Response>(id: "DeleteSource", tag: "Sources", method: "DELETE", path: "/beta/sources/{sourceId}", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["poi:sources:delete"]), SecurityRequirement(type: "OIDC", scopes: ["poi:sources:delete"])])
