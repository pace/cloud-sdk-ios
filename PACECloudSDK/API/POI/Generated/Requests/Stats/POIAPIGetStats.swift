...
extension POIAPI.Stats {
    ...
    */
    public enum GetStats {
        ...
        public static var service = POIAPIService<Response>(id: "GetStats", tag: "Stats", method: "GET", path: "/stats", hasBody: false, securityRequirements: [])
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public var data: PCPOIStats?

                public init(data: PCPOIStats? = nil) {
                    self.data = data
                }
