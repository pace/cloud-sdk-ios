...
extension POIAPI.Delivery {
    ...
    public enum DeleteGasStationReferenceStatus {
        ...
        public static var service = POIAPIService<Response>(id: "DeleteGasStationReferenceStatus", tag: "Delivery", method: "DELETE", path: "/delivery/gas-stations/{gasStationId}/reference-status/{reference}", hasBody: false, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["poi:gas-stations.references:update"]), SecurityRequirement(type: "OIDC", scopes: ["poi:gas-stations.references:update"])])
