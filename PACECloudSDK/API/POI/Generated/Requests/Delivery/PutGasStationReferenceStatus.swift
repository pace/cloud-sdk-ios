...
extension POIAPI.Delivery {
    ...
    public enum PutGasStationReferenceStatus {
        ...
        public static let service = APIService<Response>(id: "PutGasStationReferenceStatus", tag: "Delivery", method: "PUT", path: "/beta/delivery/gas-stations/{gasStationId}/reference-status/{reference}", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["poi:gas-stations.references:update"]), SecurityRequirement(type: "OIDC", scopes: ["poi:gas-stations.references:update"])])
