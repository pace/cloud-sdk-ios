...
extension POIAPI.Admin {
    ...
    public enum DeduplicatePoi {
        ...
        public static var service = POIAPIService<Response>(id: "DeduplicatePoi", tag: "Admin", method: "PATCH", path: "/admin/poi/dedupe", hasBody: true, securityRequirements: [SecurityRequirement(type: "OAuth2", scopes: ["poi:pois:update"]), SecurityRequirement(type: "OIDC", scopes: ["poi:pois:update"])])

        public final class Request: POIAPIRequest<Response> {

            public class Body: APIModel {

                public var data: PCPOIDedupeRequest?

                public init(data: PCPOIDedupeRequest? = nil) {
                    self.data = data
                }
