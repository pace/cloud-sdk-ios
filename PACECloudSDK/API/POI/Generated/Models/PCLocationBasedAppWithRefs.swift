...
public class PCLocationBasedAppWithRefs: APIModel {
     ...
     */
        ...
        public init(androidInstantAppUrl: String? = nil, appType: PCAppType? = nil, cache: PCCache? = nil, createdAt: DateTime? = nil, deletedAt: DateTime? = nil, logoUrl: String? = nil, pwaUrl: String? = nil, references: [String]? = nil, subtitle: String? = nil, title: String? = nil, updatedAt: DateTime? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCLocationBasedAppWithRefs else { return false }
    ...
    public static func == (lhs: PCLocationBasedAppWithRefs, rhs: PCLocationBasedAppWithRefs) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
