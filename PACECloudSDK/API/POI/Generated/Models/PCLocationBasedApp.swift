...
public class PCLocationBasedApp: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCLocationBasedApp else { return false }
    ...
    public static func == (lhs: PCLocationBasedApp, rhs: PCLocationBasedApp) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
