...
public class PCCommonOpeningHours: APIModel {
    ...
    public class Rules: APIModel {
        ...
        public init(action: PCAction? = nil, days: [PCDays]? = nil, timespans: [Timespans]? = nil) {
            self.action = action
            self.days = days
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCCommonOpeningHours else { return false }
      guard self.rules == object.rules else { return false }
      guard self.timezone == object.timezone else { return false }
      return true
    }

    public static func == (lhs: PCCommonOpeningHours, rhs: PCCommonOpeningHours) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
