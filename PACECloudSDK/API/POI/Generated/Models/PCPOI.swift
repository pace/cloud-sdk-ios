...
public class PCPOI: APIModel {
    ...
    public class Attributes: APIModel {
        ...
        public var boundary: PCCommonGeoJSONPolygon?
        ...
        public init(active: Bool? = nil, boundary: PCCommonGeoJSONPolygon? = nil, countryId: PCCommonCountryId? = nil, createdAt: DateTime? = nil, data: [PCFieldData]? = nil, lastSeenAt: DateTime? = nil, metadata: [PCFieldMetaData]? = nil, position: PCCommonGeoJSONPoint? = nil, references: [String]? = nil, updatedAt: DateTime? = nil) {
            self.active = active
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? PCPOI else { return false }
    ...
    public static func == (lhs: PCPOI, rhs: PCPOI) -> Bool {
        return lhs.isEqual(to: rhs)
    }
}
