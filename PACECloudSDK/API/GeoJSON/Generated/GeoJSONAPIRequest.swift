...
public class GeoJSONAPIRequest<ResponseType: APIResponseValue> {

    public let service: GeoJSONAPIService<ResponseType>
    ...
    public init(service: GeoJSONAPIService<ResponseType>,
...
extension GeoJSONAPIRequest: CustomStringConvertible {
...
extension GeoJSONAPIRequest: CustomDebugStringConvertible {
...
public class CancellableGeoJSONAPIRequest {
    /// The request used to make the actual network request
    public let request: AnyGeoJSONAPIRequest

    init(request: AnyGeoJSONAPIRequest) {
